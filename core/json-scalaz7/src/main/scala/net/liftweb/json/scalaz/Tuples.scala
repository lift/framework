  ...
  implicit def Tuple4JSON[A: JSON, B: JSON, C: JSON, D: JSON]: JSON[(A, B, C, D)] =
    new JSON[(A, B, C, D)] {
      ...
      def write(value: (A, B, C, D)) =
        JArray(toJSON(value._1) :: toJSON(value._2) :: toJSON(value._3) :: toJSON(value._4) :: Nil)
    }
    ...
    new JSON[(A, B, C, D, E)] {
      def read(json: JValue) = json match {
        case JArray(a :: b :: c :: d :: e :: _) =>
          (fromJSON[A](a) |@| fromJSON[B](b) |@| fromJSON[C](c) |@| fromJSON[D](d) |@| fromJSON[E](
            e)) { (a, b, c, d, e) => (a, b, c, d, e) }
        case x => failure(UnexpectedJSONError(x, classOf[JArray])).toValidationNel
      }

      def write(value: (A, B, C, D, E)) = JArray(toJSON(value._1) :: toJSON(
        value._2) :: toJSON(value._3) :: toJSON(value._4) :: toJSON(value._5) :: Nil)
    }
  ...
  implicit def Tuple6JSON[A: JSON, B: JSON, C: JSON, D: JSON, E: JSON, F: JSON]
    ...
    def read(json: JValue) = json match {
      case JArray(a :: b :: c :: d :: e :: f :: _) =>
        (fromJSON[A](a) |@| fromJSON[B](b) |@| fromJSON[C](c) |@| fromJSON[D](d) |@| fromJSON[E](
          e) |@| fromJSON[F](f)) { (a, b, c, d, e, f) => (a, b, c, d, e, f) }
      case x => failure(UnexpectedJSONError(x, classOf[JArray])).toValidationNel
    }

    def write(value: (A, B, C, D, E, F)) = JArray(toJSON(value._1) :: toJSON(value._2) :: toJSON(
      value._3) :: toJSON(value._4) :: toJSON(value._5) :: toJSON(value._6) :: Nil)
  }
}
