...
class InlineParsersTest extends AnyFlatSpec with Matchers with InlineParsers {
  ...
  /**
   * These should pass the inline replacement unchanged and can be used to be put between "real
   * tests" to simualate intermediate text.
   */
  val dummyTests = List(
  ...
  it should "resolve reference links" in {
    ...
    apply(
      p,
      "[text][id]") should equal("""<a href="http://www.example.com" title="Title">text</a>""")
    apply(
      p,
      "[text] [id]") should equal("""<a href="http://www.example.com" title="Title">text</a>""")
    ...
    apply(
      p,
      "[id] [Id 2]") should equal("""<a href="http://other.example.com" title="Title 2">id</a>""")
  ...
  it should "resolve reference images" in {
    ...
    apply(
      p,
      "![id][]") should equal("""<img src="http://www.example.com" alt="id" title="Title" />""")
    apply(
      p,
      "![id] []") should equal("""<img src="http://www.example.com" alt="id" title="Title" />""")
    apply(
