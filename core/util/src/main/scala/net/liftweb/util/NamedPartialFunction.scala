...
/**
 * This trait is used to represent a PartialFunction with additional associated metadata, a name
 * that allows the NamedPartialFunction to be looked up dynamically.
 */
...
object NamedPF {
   ...
   * @param lst
   *   the sequence to search for a PartialFunction defined at <code>value</code>
   * @return
  ...
  /**
   * Determine whether any PartialFunction in the specified sequence is defined at the specified
   * value.
   *
   * @param value
   *   the value to use to test each PartialFunction
  ...
  /**
   * Find the first PartialFunction in the specified sequence that is defined at the specified
   * value, apply it to that value and return the result or throw a MatchError on failure to find
   * such a function.
   *
   * @param value
   *   the value to use to test each PartialFunction
  ...
  /**
   * Find the first PartialFunction in the specified sequence that is defined at the specified
   * value, apply it to that value and return the result in a Full Box if found; return Empty
   * otherwise
   *
   * @param value
   *   the value to use to test each PartialFunction
   ...
   *   the sequence to search for a PartialFunction defined at <code>value</code>
   * @return
   *   a Full Box containing the result of applying the first PartialFunction which is defined at
   *   the specified value to that value, or Empty if no such PartialFunction is found
   */
