        ...
        case Left(l) => {
          ...
          l must_==
            List(
              ...
              VCardEntry(
                VCardKey("TEL", List(("type", "HOME"), ("type", "VOICE"), ("type", "pref"))),
                List("555-610-6679")),
              VCardEntry(
                VCardKey("ADR", List(("type", "HOME"), ("type", "pref"))),
                List("", "", "1747 Steuart Street", "Tiburon", "CA", "94920", "USA")),
        ...
        case Left(l) => {
          ...
          l must_==
            List(
              ...
              VCardEntry(
                VCardKey("EMAIL", List(("type", "INTERNET"), ("type", "WORK"), ("type", "pref"))),
                List("John-Appleseed@mac.com")),
              VCardEntry(
                VCardKey("TEL", List(("type", "CELL"), ("type", "VOICE"), ("type", "pref"))),
                List("888-555-5512")),
              VCardEntry(
              ...
              VCardEntry(
                ...
                List("", "", "3494 Kuhl Avenue", "Atlanta", "GA", "30303", "USA")),
              VCardEntry(VCardKey("X-ABADR", Nil), List("ca")),
              VCardEntry(
                VCardKey("ADR", List(("type", "HOME"))),
                List("", "", "1234 Laurel Street", "Atlanta", "GA", "30303", "USA")),
              VCardEntry(VCardKey("X-ABADR", Nil), List("us")),
