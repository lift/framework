...
/**
  * Systems under specification for MongoSave.
  */
class MongoSaveSpec extends Specification with MongoTestKit {
  "MongoSave Specification".title

  import mongosaverecords._
