...
object LiftSbtHelpers {
   ...
   *
   * It is a convenience method to create a Lift `ProjectReference` module by having the boilerplate
   * for most common activities tucked in.
   *
   * @param base
   ...
   * @param module
   *   the name of the project module. Typically, a project id is of the form lift-`module`.
   */
  ...
  /**
   * A helper that returns the revision and JAR file for a given dependency. Useful when trying to
   * attach API doc URI information.
   */
