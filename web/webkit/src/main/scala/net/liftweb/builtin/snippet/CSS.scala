...
object CSS extends DispatchSnippet {
   ...
   *
   * to your template and Lift will replace it with the path to the blueprint css styles (screen and
   * print media)
   */
   ...
   *
   * to your template and Lift will replace it with the path to the blueprint fancy-type plugin css
   * styles (screen media)
   */
