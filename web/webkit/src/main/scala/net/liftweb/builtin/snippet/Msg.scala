 ...
 * given id. Typically this will be used near by form fields to indicate that a certain field failed
 * the validation. For example:
 *
 * <pre name="code" class="xml"> &lt;input type="text" value=""
 * name="132746123548765"/&gt;&lt;lift:msg id="user_msg"/&gt; </pre>
 *
 * Additionally, you may specify additional CSS classes to be applied to each type of notice using
 * the followin attributes:
 *
 * <ul> <li>errorClass</li> <li>warningClass</li> <li>noticeClass</li> </ul>
 *
 * <pre name="code" class="xml"> &lt;input type="text" value=""
 * name="132746123548765"/&gt;&lt;lift:msg id="user_msg" errorClass="error_class"
 * warningClass="warning_class" noticeClass="notice_class"/&gt; </pre>
 *
...
object Msg extends DispatchSnippet {
  ...
  /**
   * This method performs extraction of the CSS class attributes as well as rendering of any
   * messages for the given id.
   */
  ...
  /**
   * This method renders the &lt;span/> for a given id's notices, along with any effects configured
   * for the id.
   *
   * @see
   *   net.liftweb.http.S#error(String,String)
  ...
  /**
   * This method produces and appends a script element to lift's page script to render effects on a
...
/**
 * This SessionVar holds a map of per-id CSS classes for error notices so that the AJAX and static
...
/**
 * This SessionVar holds a map of per-id CSS classes for warning notices so that the AJAX and static
 * renderers use the same formatting.
 */
...
/**
 * This SessionVar holds a map of per-id CSS classes for notice notices so that the AJAX and static
 * renderers use the same formatting.
 */
