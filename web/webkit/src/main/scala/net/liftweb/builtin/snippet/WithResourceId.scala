...
/**
 * Adds a resource id entity for each URI in order to control browser caching. The rules of creating
 * "unique" URI's are defined in LiftRules.attachResourceId function.
 *
 * <pre> &lt;lift:with-resource-id> &lt;link ... /> &lt;script ... /> &lt;/lift:with-resource-id>
 * </pre>
 */
